...
const dict = {
  vi: {
    ...
    footer: { built: 'Xây bằng Next.js, Three.js & PostgreSQL' },
  },
  en: {
    nav: {
      about: 'About',
    ...
    footer: { built: 'Built with Next.js, Three.js & PostgreSQL' },
  },
}
...
export function LangProvider({ children }) {
  // SSR không có localStorage — khởi tạo 'vi', đồng bộ lại ngay khi mount
  const [lang, setLang] = useState('vi')

  useEffect(() => {
    if (localStorage.getItem('portfolio-lang') === 'en') setLang('en')
  }, [])
